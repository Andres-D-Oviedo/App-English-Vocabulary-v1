...
class ActivityPlayAnimalCat : AppCompatActivity() {

    private lateinit var binding: ActivityPlayAnimalCatBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityPlayAnimalCatBinding.inflate(layoutInflater)
    ...
    private fun initListeners() {
        ...
        binding.btnPlayNext.setOnClickListener{
            navigateToActivityPlayAnimalCow()
        }

    }

    private fun navigateToActivityPlayAnimalCow(){
        val intent = Intent(this, ActivityPlayAnimalCow::class.java)
    ...
    private fun setCorrectColor() {
        ...
        binding.viewCard.setCardBackgroundColor(getCorrectColor(isOptCatSelected))
    }
