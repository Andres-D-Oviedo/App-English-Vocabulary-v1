...
import com.sena.appenglish.databinding.ActivityPlayAnimalCowBinding

class ActivityPlayAnimalCow : AppCompatActivity() {

    private lateinit var binding: ActivityPlayAnimalCowBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityPlayAnimalCowBinding.inflate(layoutInflater)
    ...
    private fun initListeners() {
        ...
        binding.btnPlayNext.setOnClickListener{
            navigateToActivityPlayAnimalBee()
        }

    }

    private fun navigateToActivityPlayAnimalBee(){
        val intent = Intent(this, ActivityPlayAnimalBee::class.java)
    ...
    private fun setCorrectColor() {
        binding.viewCard.setCardBackgroundColor(getCorrectColor(isOptCowSelected))
    }
