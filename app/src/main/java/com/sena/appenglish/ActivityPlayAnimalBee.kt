...
import com.sena.appenglish.databinding.ActivityPlayAnimalBeeBinding
import com.sena.appenglish.databinding.ActivityPlayAnimalCatBinding

class ActivityPlayAnimalBee : AppCompatActivity() {

    private lateinit var binding: ActivityPlayAnimalBeeBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityPlayAnimalBeeBinding.inflate(layoutInflater)
    ...
    private fun initListeners() {
        ...
        binding.btnPlayNext.setOnClickListener{
            navigateToActivityPlayAnimalHen()
        }
    }

    private fun navigateToActivityPlayAnimalHen(){
        val intent = Intent(this, ActivityPlayAnimalHen::class.java)
    ...
    private fun setCorrectColor() {
        ...
        binding.viewCard.setCardBackgroundColor(getCorrectColor(isOptBeeSelected))
    }
